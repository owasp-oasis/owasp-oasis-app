...
export default function Dashboard() {
  ...
  const metrics = useMemo(() => {
    ...
    return {
      ...
      totalValidations: prs.reduce((sum, pr) => sum + number(pr.consensus_accept) + number(pr.consensus_modify) + number(pr.consensus_reject) + number(pr.consensus_duplicate), 0),
    }
  }, [prs, repos.length])
