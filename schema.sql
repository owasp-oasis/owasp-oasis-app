...
-- Durable outbox for registration/application contact synchronization.
-- Contact payloads remain in D1 until HubSpot confirms success; scheduled
-- retries use next_attempt_at and reclaim interrupted processing locks.
